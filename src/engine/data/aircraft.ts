...
export const MODELS: Record<ModelKey, AircraftModel> = {
  ...
  B73F: { name: 'Boeing 737-800BCF', kind: 'Cargueiro narrowbody', tier: 1, y: 0, j: 0, cargo: 24, range: 3700, speed: 840, fuelKm: 13.3, crewH: 2600, lease: 32100, price: 37e6, deliveryAge: 15, wearH: 0.075, util: 15, minRunway: 1600, unpaved: false },
  B763F: { name: 'Boeing 767-300F', kind: 'Cargueiro widebody', tier: 2, y: 0, j: 0, cargo: 57, range: 7000, speed: 850, fuelKm: 28, crewH: 5000, lease: 19200, price: 12e6, deliveryAge: 20, maintBase: 60e6, wearH: 0.09, util: 18, minRunway: 2200, unpaved: false },
};
