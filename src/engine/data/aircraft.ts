...
export const MODELS: Record<ModelKey, AircraftModel> = {
  AT7: { name: 'ATR 72-600', kind: 'Turboélice', tier: 0, y: 70, j: 0, range: 1500, speed: 500, fuelKm: 7, crewH: 1800, lease: 28000, price: 55e6, wearH: 0.08, util: 15, minRunway: 1000, unpaved: false },
  E295: { name: 'Embraer E195-E2', kind: 'Jato regional', tier: 1, y: 132, j: 0, range: 4800, speed: 830, fuelKm: 11, crewH: 3000, lease: 68000, price: 105e6, wearH: 0.07, util: 16, minRunway: 1300, unpaved: false },
  A20N: { name: 'Airbus A320neo', kind: 'Narrowbody', tier: 1, y: 174, j: 0, range: 6300, speed: 840, fuelKm: 13, crewH: 3600, lease: 88000, price: 145e6, wearH: 0.065, util: 17, minRunway: 1300, unpaved: false },
  B38M: { name: 'Boeing 737 MAX 8', kind: 'Narrowbody', tier: 1, y: 186, j: 0, range: 6500, speed: 840, fuelKm: 13.5, crewH: 3800, lease: 94000, price: 152e6, wearH: 0.065, util: 17, minRunway: 1300, unpaved: false },
  A339: { name: 'Airbus A330-900', kind: 'Widebody', tier: 2, y: 257, j: 30, range: 13300, speed: 870, fuelKm: 27, crewH: 8500, lease: 230000, price: 420e6, wearH: 0.05, util: 22, minRunway: 2200, unpaved: false },
  C208: { name: 'Cessna Grand Caravan EX', kind: 'Monomotor turboélice', tier: 0, y: 12, j: 0, range: 1689, speed: 343, fuelKm: 2.7, crewH: 600, lease: 4300, price: 6.4e6, wearH: 0.09, util: 10, minRunway: 700, unpaved: true },
  PC12: { name: 'Pilatus PC-12 NGX', kind: 'Monomotor pressurizado', tier: 0, y: 9, j: 0, range: 3269, speed: 500, fuelKm: 1.65, crewH: 650, lease: 9900, price: 14.7e6, wearH: 0.08, util: 11, minRunway: 800, unpaved: true },
  DHC6: { name: 'DHC-6 Twin Otter 300-G', kind: 'Bimotor de pista curta', tier: 0, y: 19, j: 0, range: 1322, speed: 315, fuelKm: 3.9, crewH: 900, lease: 12300, price: 18.3e6, wearH: 0.09, util: 11, minRunway: 500, unpaved: true },
